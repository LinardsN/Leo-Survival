...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool isSprinting = Input.GetKey(KeyCode.LeftShift) && stamina > 0 && stamina > sprintStaminaCost * Time.deltaTime;
        float sprintMultiplier = isSprinting ? 2 : 1;

        // Set the stamina regeneration rate based on whether the player is sprinting or not
        float staminaRegenRate = isSprinting ? nonSprintStaminaRegenRate : nonSprintStaminaRegenRate * 2;
